...
ck_assert_str_eq((char *)s21_memcpy(str3, str, 4),(char *)memcpy(str3, str, 4));
...
ck_assert_str_eq(s21_strncat(strka1,",Four,Five",20),strncat(strka2,",Four,Five",20));

char strka3[100] = "Good";
char strka4[100] = "Good";
ck_assert_str_eq(s21_strncat(strka3,"Morning",10),strncat(strka4,"Morning",10));
...
char* needle10 = "is a";
ck_assert_ptr_eq(s21_strstr(haystack10, needle10), strstr(haystack10, needle10));
